    ...
    const fetchRentalProperties = async () => {
      try {
        let query = supabase
          ...
          .eq("purpose", "Temporada") // Filter for seasonal rentals
        ...
        console.error("Erro ao buscar propriedades de temporada:", err.message)
        setError("Falha ao carregar imóveis de temporada. Tente novamente.")
      } finally {
        setLoading(false)
      }
    }
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Imóveis para Temporada</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Confira nossas opções de imóveis para aluguel de temporada
            </p>
          </div>
  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Imóveis para Temporada</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">Confira nossas opções de imóveis para aluguel de temporada</p>
        </div>
                ...
                <Link href={`/imovel/${property.id}`}>
                  <div className="relative h-48 cursor-pointer">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                      <Image
                        src="/images/rieger-logo.png"
                        alt="Rieger Imóveis Logo"
                        width={100}
                        height={100}
        ...
        {properties.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-600">Nenhum imóvel de temporada disponível no momento.</p>
          </div>
        )}
